...
struct BuildTransitionJob : IJobForEachWithEntity<LocalToWorld, BuildRange>
{
    public EntityCommandBuffer.Concurrent buffer;

    public void Execute(Entity entity, int index, [ReadOnly] ref LocalToWorld c1, [ReadOnly] ref BuildRange c3)
    {
